...
![대표적인 웹서버](blog/2025-06-15-서블릿깊게이해/screen1.png)

초창기의 웹의 출현 이후 정적(Static) 웹페이지가 대부분이였다. 웹서버는 요청한 HTML 파일을 그대로 내려주는 방식으로 동작한다. 
![웹서버 동작방식](blog/2025-06-15-서블릿깊게이해/screen3.png)
...
![CGI 동작방식](blog/2025-06-15-서블릿깊게이해/screen5.png)
...
![WAS만 사용](blog/2025-06-15-서블릿깊게이해/screen6.png)
...
![WAS & WebServer 사용](blog/2025-06-15-서블릿깊게이해/screen7.png)
...
![WAS서버](blog/2025-06-15-서블릿깊게이해/screen2.png)
