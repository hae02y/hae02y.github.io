...
- **소개** : 자격증 정보를 한눈에! 자격증 조회서비스 study ground 입니다.
- **기간** : 2023.08 ~ 2023.09 (4주) 
- **인원** : Backend 4명, Frontend 3명 (총 7명)
- [🔗 레포지토리 링크](https://github.com/hae02y/seb45_main_016)
</aside>

### 핵심 기술 스택

- **Backend:** Java, Spring Boot, Spring Security, JPA, Hibernate, Spring Batch
- **Database:** MySQL, AWS RDS
- **CI/CD & DevOps:** Docker, AWS EC2, S3, Github Actions, CodeDeploy
...
- ##### **Backend (60%)**
    - **외부 API 연동 및 데이터 처리 (100%)**
        - Q-net 자격증 정보 및 시험 관련 날짜 데이터를 외부 API를 통해 연동하여 자동으로 업데이트 및 처리
    - **DB 설계 및 API 문서 작성 (100%)**
        - MySQL 데이터베이스 설계 및 테이블 구조 정의
        - 각 API에 대한 명세서 작성 및 문서화
    - **스프링 배치 스케줄링 구현 (100%)**
        - 스프링 배치를 사용하여 정기적인 작업(예: 데이터 업데이트)을 자동화하는 스케줄링 구현
    - **게시글 CRUD 구현 (100%)**
        - 게시글 등록, 조회, 수정, 삭제 기능을 제공하는 API 개발
        - JPA를 활용하여 데이터 저장 및 조회 최적화
    - **댓글 CUD 구현 (100%)**
        - 댓글 생성, 수정, 삭제 기능을 제공하는 API 개발
    - **대댓글 CUD 구현 (100%)**
        - 대댓글 생성, 수정, 삭제 기능을 제공하는 API 개발
    - **북마크 기능 구현 (100%)**
        - 사용자별 북마크 추가 및 삭제 기능을 제공하는 API 개발
    - **메인페이지 기능 구현 (100%)**
        - 메인페이지에 필요한 데이터 조회 및 화면 구성 기능 구현
    - **게시글 자격증 검색 (100%)**
        - 자격증 관련 게시글을 검색할 수 있는 API 개발
        - 게시글의 자격증 정보를 기반으로 필터링 및 검색 기능 구현

- #### **Soft Skill(30%)**
  - **팀장 역할 수행(100%)**
    - Frontend 3명, Backend 4명이서 함께 진행한 프로젝트에서 팀장 역할 수행
...
### 결과 및 피드백
<aside> 
- Frontend 3명, Backend 4명이서 함께 진행한 프로젝트에서 **팀장 역할**을 맡았습니다. 협업 과정에서 소통을 하는 방법을 많이 고민하였습니다. 이를 통해서 성공적인 결과를 이끌어냈으며 팀원들에게 긍정적인 평가를 받았습니다.
...
📢 제가 프로젝트에서 사용하였던 Spring Batch에 대해서 리뷰를 진행 하였습니다.   
[유튜브 영상](https://youtu.be/dHjzRMszBYc?si=ARnF-hFQB8UVe2mH&t=992)
...
1. [API 명세서](https://documenter.getpostman.com/view/14800466/2s9Y5YTNmE)
2. [화면정의서](https://www.figma.com/file/NF7uc1KKci1hk4c0BDhWMm/STUDY-GROUND-%ED%99%94%EB%A9%B4-%EC%A0%95%EC%9D%98%EC%84%9C_%EC%9D%BC%EB%8B%A8-%ED%95%B4-%EB%B3%B4%EC%A3%A0?type=whiteboard)
</details>
