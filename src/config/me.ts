        ...
        bulletGroups: [
          {
            title: '블로그 운영',
            bullets: [
              'Next.js와 Markdown 기반으로 [개발 기술 블로그](https://blog.hae02y.me/)를 직접 구축하고, 기술 콘텐츠를 기록하고 있습니다.',
              '누적 25만 방문의 [IT 기술 블로그](https://togll.tistory.com/)를 운영하고 있습니다.',
              '[브런치스토리](https://brunch.co.kr/@hae02y) 작가로 활동하며, 일상과 생각을 글로 기록하고 있습니다.',
            ],
          },
        ],
      },
